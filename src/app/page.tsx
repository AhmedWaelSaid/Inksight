      ...
      <MaxwidthWrapper ClassName="mb-12  mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        <div className="mx-auto mb-4 flex max-w-fit items-center justify-center space-x-2 overflow-hidden rounded-full border border-gray-200 bg-white px-7 py-2 shadow-md backdrop-blur transition-all hover:border-gray-200 hover:bg-white/50">
          <p className="text-sm text-gray-700  font-semibold">
            Read-H is now public!
          </p>
        </div>
        <h1 className="max-w-4xl text-5xl font-bold md:text-6xl lg:text-7xl">
          Chat with your <span className="text-green-600">PDFS</span> in
          seconds.
        </h1>
        ...
        <div className="relative isolate">
          ...
          >
            <div
              ...
              className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#66ff00] to-[#2af33e] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            />
          </div>
          ...
          >
            <div
              ...
              className="relative left-[calc(50%-13rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#66ff00] to-[#2af33e] opacity-30 sm:left-[calc(50%-38rem)] sm:w-[72.1875rem]"
            />
          </div>
        </div>
      </div>
        ...
        <ol className='my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0'>
          ...
          <li className='md:flex-1'>
            <div className='flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4'>
              ...
              <span className='mt-2 text-zinc-700'>
                It&apos;s that simple. Try out Read-H today -
